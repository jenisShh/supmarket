...
const Pizzas1 = () => {
	...
	const Pizza1 = ({pizza1}) => {
		return(
            ...
            <Card.Img  src={`${pizza1.images[0].imageName}`} />
            <Card.Body>
                <Card.Title>
                    {`${pizza1.title}`}
                </Card.Title>
                <Card.Subtitle className= "mb-2 text-muted">  
                    {`${pizza1.categoryTitle}`}
                </Card.Subtitle>
				<p>NRS {`${pizza1.unitPrice[0].sellingPrice}`}</p> 
    ...
    return (
            ...
            <div class="breadcrumbs">
                <div class="container">
                    <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                        ...
                        <li class="active">PIZZA SUB 1</li>
                    </ol>
                </div>
	        </div>
      ...
      <p className="mt-2" >We've got something for everyone</p>
       <Row>
                {loading && 
                    pizzas1.filter((pizza1) => pizza1.categoryId===1).map((pizza1) => (
                        <Col sm={12} md={6} lg={4} key= {pizza1.id}> 
