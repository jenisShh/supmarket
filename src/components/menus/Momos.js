...
const Momos = () => {
	...
	const Momo = ({momo}) => {
		return(
            ...
            <Card.Img  src={`${momo.images[0].imageName}`} />
            <Card.Body>
                <Card.Title>
                    {`${momo.title}`}
                </Card.Title>
				...
				<p>NRS {`${momo.unitPrice[0].sellingPrice}`}</p> 
    ...
    return (
		...
		<div class="container">
			<div class="col-md-4 products-left">
				<div class="categories">
					<h2>Categories</h2>
					<ul class="cate">
						<li><a href="/Allitems"><i class="fa fa-arrow-right" aria-hidden="true"></i>All Items</a></li>
      ...
      <p className="mt-2" >We've got something for everyone</p>
       <Row>
                {loading && 
                    momos.filter((momo) => momo.categoryId===3).map((momo) => (
                        <Col sm={12} md={6} lg={4} key= {momo.id}> 
                        <Momo momo = {momo} />
                        </Col>
                )) }
